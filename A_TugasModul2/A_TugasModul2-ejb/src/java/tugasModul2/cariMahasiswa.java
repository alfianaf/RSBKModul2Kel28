...
public class cariMahasiswa implements cariMahasiswaLocal {
    ...
    public void listmhs(String nama,String nim){
        datar.add(new Mahasiswa(nama,nim));
    }
    
    public cariMahasiswa() {
          listmhs("Rio Kisna Eka Putra","21120116130060");
          listmhs("Alfian Aulia Firdaus","21120116130035");
          listmhs("Favo Perdana HS","21120116120015");
          listmhs("Farrell Denando","21120116120022");
          listmhs("Faisal Rizki R","21120116120014");
    }
